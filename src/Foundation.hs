...
instance Yesod App where
    ...
    defaultLayout widget = do
        ...
        let menuItems =
                ...
                , NavbarLeft $ MenuItem
                    { menuItemLabel = "Portfolio"
                    , menuItemRoute = PortfolioR
                    , menuItemAccessCallback = isJust muser
                    }
                , NavbarLeft $ MenuItem
                    { menuItemLabel = "Diagnosis"
                    , menuItemRoute = DiagnosisR
                    , menuItemAccessCallback = isJust muser
                    }
                , NavbarLeft $ MenuItem
    ...
    isAuthorized ForecastR _ = return Authorized
    ...
    isAuthorized DiagnosisR _ = isAuthenticated
